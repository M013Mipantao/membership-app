...
class WizardController extends Controller
{
    ...
    public function complete(Request $request)
    {
        ...
        // $duration = isset($qrCode->enddate) ? convertDateTimeToString($qrCode->startdate).' to '.convertDateTimeToString($qrCode->enddate) : convertDateTimeToString($qrCode->startdate);
